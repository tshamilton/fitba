	...
	foreach ($tCols as $cL) {
		...
		for ($cL = $cL; $cL > 0; $cL--) {
			...
			switch ($context) {
				...
				case "majorE":
					$k = strrev($k);
					print t(7)."<div class=\"team mx-1 my-2 e-".$k."\">e-".$k." <div class=\"badge badge-pill ".$k." ".substr($k,0,1)."\">".$v."</div></div>\n";
					break;
				case "majorV":
					$k = strrev($k);
					$text = substr($k, 0, 1);
				...
				case "nats":
					...
					if ($k == "INT") {
						...
						print t(7)."<div class=\"team mx-1 my-2 ".$style."\">".$Team[$name]["Name"]." <span style=\"text-shadow: none;\" class=\"badge badge-pill ".$Team[$name]["Mnr"]." ".substr($Team[$name]["Mnr"],0,1)."\"><small>".$v."</small></span> <img class=\"".substr($Team[$name]["Mnr"], 0, 1)." flag\" src=\"flags/".$k.".png\"></div>\n";
					}
					break;
				case "cNats":
					if ($k == "MKD") {
				...
				case "natsTC":
					...
					print t(7)."<div class=\"team mx-1 my-2 ".$style."\">".$Team[$name]["Name"]." <div style=\"color: inherit; text-decoration: inherit;\" class=\"badge badge-pill ".$Team[$name]["Mnr"]." ".substr($Team[$name]["Mnr"], 0, 1)."\">".$v."</div> <img class=\"".substr($Team[$name]["Mnr"], 0, 1)." flag\" src=\"flags/".$k.".png\"></div>\n";
					break;
				case "tBC":
...
<html lang="en">
	...
	<body>
		<ul class="nav nav-pills nav-fill justify-content-center">
			...
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#colours"> Colours </a></li>
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#nations"> Nations </a></li>
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#clubs"> Clubs </a></li>
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#badges"> Badges </a></li>
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#champs"> Champs </a></li>
			<li class="nav-item slate"><a role="nav-link" class="nav-link" data-toggle="pill" href="#missing"> Missing </a></li>
		</ul>
<!-- Tab panes -->
		<div class="tab-content theBody">
			<div role="tabpanel" class="tab-pane container-fluid fade mx-2 p-4 nationFrame slate" id="stats" name="stats">
			<div class="container-fluid">
				<h1 class="display-3"> Stats </h1>
				<h2 class="display-4"> Colours </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
					<div class="row">
						<div class="col-sm-2">
				...
				<h2 class="display-4"> Diacritics </h2>
				<div class="container-fluid p-4 mb-4 grass nationFrame">
					<div class="row">
			...
			<div role="tabpanel" class="tab-pane container-fluid fade mx-2 p-4 nationFrame slate" id="colours" name="colours">
			<div class="container-fluid">
				<h1 class="display-3"> Colours </h1>
				<h2 class="display-4"> Minor Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMinor"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMnS = array();
...
?>
				...
				<h2 class="display-4"> Plain Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["x"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Striped Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["s"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Edged Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["e"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Banded Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["b"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Hooped Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["h"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Offset Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["o"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Sash Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["d"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Halved Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["v"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
				...
				<h2 class="display-4"> Checkered Styles <div class="badge badge-pill k"><?php print sizeof($Stats["countMajor"]["z"]); ?> total</div></h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
	$countMjX = array();
...
?>
			...
			<div role="tabpanel" class="tab-pane container-fluid fade mx-2 p-4 nationFrame slate" id="nations" name="nations">
			<div class="container-fluid">
				<h1 class="display-3"> Nations </h1>
...
?>
			...
			<div role="tabpanel" class="tab-pane container-fluid fade mx-2 p-4 nationFrame slate" id="clubs" name="clubs">
			<div class="container-fluid">
				<a name="TOP">
				<h1 class="display-3"> Clubs </h1>
				<h2 class="display-4"> Nations </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
<?php
	foreach ($Stats["countryByTri"] as $cName) {
		...
		print t(5)."<p>&nbsp;</p>\n";
		print t(5)."<div class=\"theContent ".$tBC_s." p-2 mb-3 nationFrame\">\n";
		print t(6)."<h2 class=\"display-4\"> ".$tBC_f." ".$tBC_n." </h3>\n";
		print t(6).$dataLine;
		if ($Stats["teamCountByCountry"][$cTri] > 0) {
			print t(6)."<div class=\"theContent nationFrame grass ".$tBC_e." p-2 mb-3\" style=\"text-shadow: 0px 0px black\">\n";
...
?>
			...
			<div class="container-fluid">
				...
				<h2 class="display-4"> Badged Teams by Country </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
			...
			<div class="container-fluid">
				<h1 class="display-3"> Champs </h1>
				<h2 class="display-4"> English Premier League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> English FA Cup </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Australian A-League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Australian FFA Cup </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> French Ligue 1 </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> German 1. Bundesliga </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Spanish La Liga </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Scottish Premier League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Italian Serie A </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Portuguese Primeira Liga </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Dutch Eredivisie </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> UEFA Champions League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> UEFA Europa League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> AFC Champions League </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> UEFA European Championship </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> AFC Asian Cup </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> Copa Libertadores </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
...
?>
				...
				<h2 class="display-4"> FIFA World Cup </h2>
				<div class="d-flex justify-content-center clearfix my-3 nationFrame">
					<div class="container-fluid p-4 mb-4 grass nationFrame">
<?php
