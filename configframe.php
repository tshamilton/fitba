...
<?php
	...
	foreach ($cMn as $N => $P) {
		if ($N == "total") {
			...
			print t(9)."<div class=\"team mx-1 my-2 ".$N."\"><span> ".$N." (".$P.") </span></div>\n";
